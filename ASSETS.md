# Image assets extracted from AMP_PROPOSAL_1.html
...
|---|---|---|---|---|---|
| `[[IMG:applied-logo]]` | `images/applied-logo.webp` | top | 4,690 | | ✅ wired |
| `[[IMG:icon-linkedin]]` | `images/icon-linkedin.png` | overview | 11,647 | | ✅ wired |
| `[[IMG:icon-facebook]]` | `images/icon-facebook.png` | overview | 5,083 | | ✅ wired |
...
| `[[IMG:tip-shot-packages-continental-4]]` | `images/tip-shot-packages-continental-4.png` | packages | 25,198 | | ✅ wired |
| `[[IMG:img-packages-2]]` | `images/tip-shot-packages-continental-3.png` | packages | 58,791 | yes | ✅ wired |
| `[[IMG:tip-shot-packages-continental-5]]` | `images/img-packages.png` | packages | 56,268 | yes | ✅ wired |
| `[[IMG:tip-shot-packages-continental-6]]` | `images/tip-shot-packages-continental-2.jpg` | packages | 86,469 | yes | ✅ wired |
| `[[IMG:tip-shot-packages-continental-7]]` | `images/tip-shot-packages-continental-3.png` | packages | 58,791 | yes | ✅ wired |
| `[[IMG:tip-shot-packages-continental-8]]` | `images/tip-shot-packages-continental-4.png` | packages | 25,198 | yes | ✅ wired |
| `[[IMG:tip-shot-packages-danfoss-icmb-cam-lobe-motors]]` | `images/tip-shot-packages-continental-3.png` | packages | 58,791 | yes | ✅ wired |
